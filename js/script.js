...
//Отображение-скрытие гамбургер-меню:
...
//         '#2 Установка spikme и работа с ветками на GitHub | Марафон вёрстки  Урок 2',
...
function start() {
    gapi.client.init({
        'apiKey': 'AIzaSyBzuW9IIdd_thfrvNWaRSOgSZq7HuwhLno',
